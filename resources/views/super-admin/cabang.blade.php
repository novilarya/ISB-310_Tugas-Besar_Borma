            ...
            <table class="w-full text-left border-collapse sortable">
                <thead>
                    <tr class="border-b border-slate-200 dark:border-white/10 text-slate-500 dark:text-white/50 text-sm">
                        <th class="pb-4 font-medium px-4 sort-header">Nama Cabang</th>
                        <th class="pb-4 font-medium px-4 sort-header">Pendapatan</th>
                        <th class="pb-4 font-medium px-4 sort-header">Total Pesanan</th>
                        <th class="pb-4 font-medium px-4 sort-header">Produk Terlaris</th>
                ...
                <tbody class="text-sm">
                    ...
                    <tr class="border-b border-slate-100 dark:border-white/5 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors sortable-row">
                        ...
                        <td class="py-4 px-4 text-right">
                            <a href="{{ route('superadmin.cabang.detail', $item->id) }}" class="text-borma-purple dark:text-borma-yellow hover:text-purple-700 dark:hover:text-yellow-300 font-bold text-sm bg-slate-100 dark:bg-white/10 px-3 py-1.5 rounded-lg transition-colors inline-block">
                                Kelola
                            </a>
                        </td>
                    </tr>
