...
<head>
    ...
    <style>
        ...
        .pwd-toggle-btn { position: absolute; inset-block: 0; right: 0; padding-right: 14px; display: flex; align-items: center; cursor: pointer; background: none; border: none; outline: none; color: #9e9e9e; transition: color 0.2s; z-index: 2; }
        .pwd-toggle-btn:hover { color: #33116C; }
        .pwd-toggle-btn svg { width: 20px; height: 20px; }
    </style>
</head>
    ...
    <div class="relative z-10 flex min-h-screen items-center justify-center px-4 py-12">
        <div class="w-full max-w-lg animate-fade-in-up">
            ...
            <div class="bg-white rounded-2xl shadow-2xl p-8 sm:p-10">
                ...
                <form method="POST" action="{{ route('register.submit') }}" class="space-y-5" id="register-form" autocomplete="off">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" name="password" id="password" required placeholder="Min. 8 karakter" class="w-full pl-12 pr-11 py-3 border-2 border-neutral-200 rounded-xl text-sm text-neutral-800 placeholder-neutral-400 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all outline-none bg-neutral-50 hover:bg-white focus:bg-white" autocomplete="new-password">
                                <button type="button" class="pwd-toggle-btn" id="toggle-password" aria-label="Tampilkan password">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" name="password_confirmation" id="password_confirmation" required placeholder="Ulangi password" class="w-full pl-12 pr-11 py-3 border-2 border-neutral-200 rounded-xl text-sm text-neutral-800 placeholder-neutral-400 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all outline-none bg-neutral-50 hover:bg-white focus:bg-white" autocomplete="new-password">
                                <button type="button" class="pwd-toggle-btn" id="toggle-password-confirm" aria-label="Tampilkan password konfirmasi">
                                    <svg id="eye-icon-confirm" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                    <svg id="eye-off-icon-confirm" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="display:none;"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/></svg>
                                </button>
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        @error('g-recaptcha-response')
                            <small class="text-danger" style="color:#ef4444; font-size:11px; font-weight:600;">{{ $message }}</small>
                        @enderror
                    </div>
