                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                        ...
                        <div class="col-span-5 flex items-center gap-4">
                            <div class="w-16 h-16 bg-neutral-50 rounded-xl border border-neutral-100 flex items-center justify-center p-1.5 shrink-0 overflow-hidden">
                                @if(!empty($item['img']))
                                <img src="{{ asset('images/products/'.$item['img']) }}" alt="{{ $item['name'] }}" class="max-w-full max-h-full object-contain rounded-lg" onerror="this.classList.add('hidden');this.nextElementSibling.classList.remove('hidden');">
                                <svg class="w-8 h-8 text-neutral-300 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                                @else
