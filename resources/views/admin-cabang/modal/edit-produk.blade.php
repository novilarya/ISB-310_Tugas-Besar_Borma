        ...
        <div class="modal-body p-6">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                ...
                <div class="md:col-span-4">
                    ...
                    <input type="number" class="w-full bg-slate-50 dark:bg-black/20 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-borma-purple dark:focus:ring-borma-yellow text-slate-800 dark:text-white transition-all" name="harga_member_plus" value="{{ $produkCabang->produk->harga_member_plus }}" id="editHargaMemberPlus">
