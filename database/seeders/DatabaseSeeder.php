    ...
    public function run(): void
    {
        ...
        DB::table('pelanggans')->insert([
            [
                ...
                'kecamatan' => 'Andir',
                'alamat' => 'Perumahan Cemara Jl. Merdeka No.10 RT/RW 001/005', 
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now()
            ]
        ]);
        ...
        DB::table('cabangs')->insert([
            ...
            [
                ...
                'koordinat_gps' => '-6.919652935520861, 107.56959704234505',  
                'status' => 'Aktif',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now()
            ],
            [
                ...
                'koordinat_gps' => '-6.891871543853984, 107.63104829549702',
                'status' => 'Aktif',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now()
            ],
            [
                ...
                'koordinat_gps' => '-6.904137174451974, 107.53160424049598',
                'status' => 'Aktif',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now()
            ],
